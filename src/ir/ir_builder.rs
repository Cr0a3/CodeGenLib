...
use crate::{asm::{arg32, stack, AsmInstructionEnum::{self, *}}, error::CodeGenLibError, Builder};
...
impl IrFunctionBuilder {
    ...
    fn get_arg(&self, name: String) -> Result< ((String, u64, Option<Register>), u64), CodeGenLibError> {
        for arg in self.args.iter() {
            let arg_1 = &arg.0;
    ...
    pub fn build_arg_add(&mut self, arg1: &str, arg2: &str, result_var: &str) -> Result<(), CodeGenLibError> {
        ...
        if arg1.0.2.is_none() {
            self.generated.push( Load(Register::RAX, stack(-(arg1.1 as i64))) );
        } else {
            self.generated.push( MovReg(Register::RAX, arg1.0.2.unwrap()) );
        }

        // Move second arg into rbx
        if arg2.0.2.is_none() {
            self.generated.push( Load(Register::RBX, stack(-(arg2.1 as i64))) );
        } else {
            self.generated.push( MovReg(Register::RBX, arg2.0.2.unwrap()) );
        }

        self.generated.push( AddReg(Register::RAX, Register::RBX) );
        self.generated.push( Store(Register::RAX, stack(-(ret.1 as i64))) );
    ...
    pub fn build_return_var(&mut self, var_name: &str) -> Result<(), CodeGenLibError> {
        ...
        self.generated.push( Load(Register::RAX, stack(-(var.1 as i64)) ));
